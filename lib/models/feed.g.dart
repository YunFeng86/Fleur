...
const FeedSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'etag': PropertySchema(id: 4, name: r'etag', type: IsarType.string),
    ...
    r'siteUrl': PropertySchema(id: 17, name: r'siteUrl', type: IsarType.string),
...
extension FeedQueryFilter on QueryBuilder<Feed, Feed, QFilterCondition> {
  ...
  QueryBuilder<Feed, Feed, QAfterFilterCondition> remoteIdContains(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
