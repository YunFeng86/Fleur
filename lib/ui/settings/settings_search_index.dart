...
List<SettingsSearchEntry> buildSettingsSearchEntries(AppLocalizations l10n) {
  return [
    ...
    _setting(
      ...
      keywords: ['font', 'text', 'size', 'reader'],
    ),
    _setting(
    ...
    _section(
      ...
      keywords: ['code', 'font stack', 'wrap'],
    ),
    _setting(
      id: 'appearance.code.font',
      tab: SettingsTab.appearance,
      title: l10n.codeFontFamily,
      section: l10n.codeAppearance,
      targetId: 'appearance.code.font',
      keywords: [
        'code',
        'font',
        'mono',
    ...
    _setting(
      ...
      section: l10n.codeAppearance,
      targetId: 'appearance.code.font_size',
      keywords: [
        'code',
        'font',
        'size',
    ...
    _setting(
      ...
      section: l10n.codeAppearance,
      targetId: 'appearance.code.line_height',
    ...
    _setting(
      ...
      keywords: ['code', 'wrap', 'soft wrap', 'line wrap'],
    ),
    _section(
